...
class CustomerRepository {
    ...
    async find(id) {
        ...
        const address = new address_1.Address(customerModel.street, customerModel.number, customerModel.zip, customerModel.city);
    ...
    async findAll() {
        ...
        const customers = customerModels.map((customerModels) => {
            ...
            const address = new address_1.Address(customerModels.street, customerModels.number, customerModels.zip, customerModels.city);
            customer.changeAddress(address);
